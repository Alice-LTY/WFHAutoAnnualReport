...
def therapy_order_Colon(df, main_file_name, year, carcinoma_type):
    #### 資料選取
    ...
    therapy_types = {
    "手術": op - (rt | chem | tg),
    "手術合併化療、放療與標靶治療": op & rt & chem & tg,
    "手術合併化療與標靶治療": (op & chem & tg) - (op & rt & chem & tg),
    "手術合併化療與放療": (op & rt & chem) - (op & rt & chem & tg),
    "手術合併化療": (op & chem) - (op & chem & tg) - (op & chem & rt),
